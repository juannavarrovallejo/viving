...
class PricingPlansController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('super_admins.pricing_plans.create',compact('doctor_modules','clinic_modules'));
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        try {
            ...
            $pricing_plan->doctor_modules()->attach($request->doctor_modules);
            $pricing_plan->clinic_modules()->attach($request->clinic_modules);
            DB::commit();
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function edit(PricingPlan $pricing_plan)
    {
        $doctor_modules = PricingPlanModule::doctor()->get();
        $clinic_modules = PricingPlanModule::clinic()->get();
        $pricing_plan_doctor_modules =$pricing_plan->doctor_modules()->pluck('pricing_plan_modules.module_code')->toArray();
        $pricing_plan_clinic_modules =$pricing_plan->clinic_modules()->pluck('pricing_plan_modules.module_code')->toArray();
        return view('super_admins.pricing_plans.edit', compact('pricing_plan','doctor_modules','pricing_plan_doctor_modules','clinic_modules','pricing_plan_clinic_modules'));
    }
