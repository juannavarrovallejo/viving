...
class UpdateDoctorGeneralInfoRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'user_name' => 'required|alpha_dash|unique:doctors,user_name,'.$doctor->id,
            ...
            'tags' => 'required|array',
            'doctor_categories' => 'required|array',
            ...
            'email' => 'nullable|unique:doctors,email,'.$doctor->id,
