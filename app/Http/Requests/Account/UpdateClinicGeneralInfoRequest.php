...
class UpdateClinicGeneralInfoRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $allRules['clinic_name'] = 'required|string';
        $allRules['address_line_1'] = 'required|string';
        $allRules['address_line_2'] = 'required|string';
        // $allRules['clinic_website'] = 'nullable|url';
        $allRules['user_name'] = 'required|alpha_dash|max:55|unique:clinics,user_name,'.$clinic->id;
