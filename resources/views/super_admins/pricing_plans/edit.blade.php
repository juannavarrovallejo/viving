                        ...
                        <form id="quickForm" method="POST"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="TypeError" aria-invalid="true" id="pricing_plan-type"
                                                ...
                                                name="type">
                                                <option value="doctor"
                                                    {{ $pricing_plan->type == 'doctor' ? 'selected' : '' }}>Doctor</option>
                                                <option value="clinic"
                                                    {{ $pricing_plan->type == 'clinic' ? 'selected' : '' }}>Clinic
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div id="doctor-modules" class="form-group">
                                            <label>Doctor Modules</label>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check p-0 mb-2 d-flex align-items-center">
                                                        <input type="checkbox" id="doctor-check-all" class="mr-2" />
                                                        <label class="form-check-label" for="doctor-check-all">Select
                                                            All</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                @foreach ($doctor_modules as $module)
                                                    <div class="col-md-4 mb-2 d-flex align-items-center">
                                                        <input type="checkbox"
                                                            @if (in_array($module->module_code, $pricing_plan_doctor_modules)) {{ 'checked' }} @endif
                                                            name="doctor_modules[]" class="mr-2 doctor_modules"
                                                            value="{{ $module->module_code }}"
                                                            id="doctor_{{ $loop->index }}">
                                                        <label class="form-check-label"
                                                            for="doctor_{{ $loop->index }}">{{ $module->display_name }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div id="clinic-modules" class="form-group">
                                            <label>Clinic Modules</label>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check p-0 mb-2 d-flex align-items-center">
                                                        <input type="checkbox" id="clinic-check-all" class="mr-2" />
                                                        <label class="form-check-label" for="clinic-check-all">Select
                                                            All</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                @foreach ($clinic_modules as $module)
                                                    <div class="col-md-4 mb-2 d-flex align-items-center">
                                                        <input type="checkbox"
                                                            @if (in_array($module->module_code, $pricing_plan_clinic_modules)) {{ 'checked' }} @endif
                                                            name="clinic_modules[]" class="mr-2 clinic_modules"
                                                            value="{{ $module->module_code }}"
                                                            id="clinic_{{ $loop->index }}">

                                                        <label class="form-check-label"
                                                            for="clinic_{{ $loop->index }}">{{ $module->display_name }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
...
@section('scripts')
    ...
    <script>
        $("#doctor-check-all").click(function() {
            $('.doctor_modules').prop('checked', this.checked);
        });
        $("#clinic-check-all").click(function() {
            $('.clinic_modules').prop('checked', this.checked);
        });
        ...
        function hideShowModules() {
            ...
            if (pricing_plan_type == 'doctor') {
                $('#doctor-modules').show();
                $('#clinic-modules').hide();
            }
            if (pricing_plan_type == 'clinic') {
                $('#doctor-modules').hide();
                $('#clinic-modules').show();
            }
        }
