            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.cities.store') }}"
                                    ...
                                    @if (isset($countries))
                                        <div class="col-md-12 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select aria-describedby="CountryError" aria-invalid="true"
                                                    id="countries_drop_down"
                                                    class="form-control curr-sym @if ($errors->has('country_id')) is-invalid @endif"
                                                    name="country_id">
                                    ...
                                    @if (isset($states))
                                        <div class="col-md-12 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select required aria-describedby="StateError" aria-invalid="true"
                                                    id="states_drop_down"
                                                    class="form-control curr-sym @if ($errors->has('state_id')) is-invalid @endif"
                                                    name="state_id">
                                                    @if (count($states) > 0)
