                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <form id="quickForm" method="POST"
                            action="{{ route('super_admin.broadcasts.update', ['broadcast' => $broadcast->id]) }}"
                                                    ...
                                                    <div class="tab-pane fade mb-2 {{ $key == 0 ? 'show active' : '' }}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name[{{ $language->code }}]"
                                                                value="{{ $broadcast->getTranslation('name', $language->code) }}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description[{{ $language->code }}]" id="discription_editor_{{ $language->code }}"
                                                                ...
                                                                aria-describedby="DescriptionError-{{ $language->code }}" aria-invalid="true">{{ $broadcast->getTranslation('description', $language->code) }}</textarea>
                                ...
                                <div class="row">
                                                ...
                                                <select aria-describedby="PodcastCategoryError" aria-invalid="true"
                                                    ...
                                                    @if (count($broadcast_categories) > 0)
                                                        ...
                                                        @foreach ($broadcast_categories as $broadcast_category)
                                                            <option value="{{ $broadcast_category->id }}"
                                                                {{ $broadcast->broadcast_category_id == $broadcast_category->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select id="file_type_drop_down" aria-describedby="FileTypeError"
                                                aria-invalid="true" id="podcast_categories_drop_down"
                                                class="form-control curr-sym @if ($errors->has('file_type')) is-invalid @endif"
                                                name="file_type">
                                                <option value="">Select File Type</option>
                                                <option @if ($broadcast->file_type == 'audio') selected @endif value="audio">
                                                    Audio</option>
                                                <option @if ($broadcast->file_type == 'video') selected @endif value="video">
                                                    Video</option>
                                            </select>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="LinkTypeError" aria-invalid="true"
                                                ...
                                                name="link_type">
                                                <option @if ($broadcast->link_type == 'internal') selected @endif
                                                    value="internal">Internal</option>
                                                <option @if ($broadcast->link_type == 'external') selected @endif
                                    ...
                                    <div id="external" class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $broadcast->file_url }}" type="text" name="file_url"
                                                ...
                                                id="InputExternalLink" placeholder="Enter External Link"
                                                aria-describedby="ExternalLinkError" aria-invalid="true">
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            @if ($broadcast->image)
                                                <div class="custom-file-preview">
                                                    <img src="{{ url($broadcast->image) }}" width="75px"
                                                        height="75px" alt="{{ $broadcast->name }}">
                                                </div>
                                            @else
                                                <div class="custom-file-preview">
                                                    -- No Image Selected
