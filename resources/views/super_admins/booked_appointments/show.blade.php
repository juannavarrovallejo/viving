                ...
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Patient</h6>
                                        <p class="mb-0 text-muted">{{ $booked_appointment->patient->name ?? '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Doctor</h6>
                                        <p class="mb-0 text-muted">{{ $booked_appointment->doctor->name ?? '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Clinic</h6>
                                        <p class="mb-0 text-muted">{{ $booked_appointment->clinic->name ?? '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
