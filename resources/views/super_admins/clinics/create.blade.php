        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.clinics.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                                ...
                                                @if (count($clinic_categories) > 0)
                                                    ...
                                                    @foreach ($clinic_categories as $clinic_category)
                                                        <option value="{{ $clinic_category->id }}"
                                                            {{ old('clinic_category_ids') == $clinic_category->id ? 'selected' : '' }}>
