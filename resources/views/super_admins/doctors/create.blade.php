    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    <h2 class="main-content-title fw-bold mb-0">Doctor</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.doctors.store') }}"
                                                ...
                                                @if (count($doctor_categories) > 0)
                                                    ...
                                                    @foreach ($doctor_categories as $doctor_category)
                                                        <option value="{{ $doctor_category->id }}"
                                                            {{ old('doctor_category_ids') == $doctor_category->id ? 'selected' : '' }}>
