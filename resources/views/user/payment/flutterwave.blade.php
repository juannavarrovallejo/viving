                    ...
                    <div class="card secbg">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <img src="{{ $order->gateway->image }}" class="card-img-top gateway-img br-4"
                                        alt="..">
                                </div>
                                <div class="col-md-9">
    ...
    <script>
        ...
        function payWithRave() {
            ...
            var x = getpaidSetup({
                ...
                patient_email: "{{ $data->patient_email ?? 'example@example.com' }}",
                amount: "{{ $data->amount ?? '0' }}",
                patient_phone: "{{ $data->patient_phone ?? '0123' }}",
