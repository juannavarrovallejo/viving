                  ...
                  <div class="d-flex align-items-center gap-4 ms-md-4 mt-2">
                    ...
                    <div class="d-flex flex-column ms-md-2">
                      ...
                      <div class="d-flex align-items-center gap-2 mb-2 mt-3">
                        ...
                        <h6 class="fs-4 text-paragraphcolor fw-normal mb-0">
                          {{ $page.props.auth.user.clinic.email }}
                        </h6>
                      </div>
                      <div class="d-flex align-items-center gap-2">
                        ...
                        <h6 class="fs-4 text-paragraphcolor fw-normal mb-0">
                          {{ $page.props.auth.user.clinic.cell_phone }}
                        </h6>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-md-column flex-row mt-3 ms-2">
                    ...
                    <div class="d-flex flex-column align-items-start ms-3 ms-md-0">
                      <div class="d-flex align-items-center gap-5">
                        ...
                        >
                          <i class="bi bi-pencil-square mb-1 text-primary ms-2 fs-3"></i>
                        </Link>
                      </div>
                      <span
              ...
              >
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    :class="{ active: active_tab == 'notifications' }"
                ...
                <li class="nav-item" role="presentation">
                  <button
                    class="nav-link"
                    id="pills-appointments-tab"
                    :class="{ active: active_tab == 'appointments' }"
                    @click="changeTab('appointments')"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-appointments"
                    type="button"
                    role="tab"
                    aria-controls="pills-appointments"
                    aria-selected="true"
                  >
                    <div class="icon-background ms-2">
                ...
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    @click="changeTab('wallet-transactions')"
                    id="pills-wallet-tab"
                    data-bs-toggle="pill"
                ...
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    @click="changeTab('subscription-plan')"
                    data-bs-toggle="pill"
          ...
          <div class="col-md-8 pe-md-0">
            <div class="tab-content" id="v-pills-tabContent">
              ...
              <div
                ...
                :class="{ 'active show': active_tab == 'appointments' }"
              >
                <dashboard-appointment
                  v-if="active_tab == 'appointments'"
                  :active="active_tab == 'appointments'"
                ></dashboard-appointment>
              </div>
              <div
                class="tab-pane fade"
                ...
                :class="{ 'active show': active_tab == 'wallet-transactions' }"
              >
                <wallet-transaction
                  v-if="active_tab == 'wallet-transactions'"
                  :active="active_tab == 'wallet-transactions'"
                ></wallet-transaction>
              </div>
              <div
                class="tab-pane fade scrollbar-custom"
                id="pills-plan"
                role="tabpanel"
              ...
              >
                <pricing-plans
                  v-if="active_tab == 'subscription-plan'"
                  :active="active_tab == 'subscription-plan'"
...
import DashboardNotification from "@/Components/Clinics/Dashboard/DashboardNotification.vue";
import DashboardAppointment from "@/Components/Clinics/Dashboard/DashboardAppointment.vue";
import WalletTransaction from "@/Components/Clinics/Dashboard/WalletTransaction.vue";
import PricingPlans from "@/Components/Clinics/Dashboard/PricingPlans.vue";
