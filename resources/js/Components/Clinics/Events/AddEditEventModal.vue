        ...
        <div class="modal-body">
          <div class="row">
            ...
            <!-- <div class="col-md-6">
                    ...
                    <input id="doctor-sponser_image" ref="formSponserImage" class="w-100 custom-file-input"   @change="onSponserFileChange" type="file" />
                        </div>
                    </div> -->
            <!-- <div> -->
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                <label class="mb-2 fs-4" for="starts_at">{{
                  __("start date")
                }}</label>
                <VueDatePicker
                  :is24="false"
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                <label class="mb-2 fs-4" for="ends_at">{{
                  __("end date")
                }}</label>
                <VueDatePicker
                  :is24="false"
            ...
            <div class="col-md-12">
              ...
              >
                ...
                <div class="col-md-6" id="form">
                  <label for="form" class="mb-2 fs-4">{{
                    __("select logo")
                  }}</label>
                  <div
                  ...
                  >
                    <div class="form-group">
                      <label
                        for="doctor-image"
                        class="btn btn-secondary text-white opacity-50 px-5 mb-0"
...
export default defineComponent({
  ...
  methods: {
    ...
    computed: {},
    create() {
      this.form.post(this.route("clinics.clinic_events.store"), {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    update() {
      this.form
        ...
        .post(
          this.route("clinics.clinic_events.update", {
            clinic_event: this.modalData.id,
          }),
          {
            preserveState: true,
            preserveScroll: true,
