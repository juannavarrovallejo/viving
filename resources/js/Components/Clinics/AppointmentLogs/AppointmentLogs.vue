...
import ClinicAppointmentListCard from "@/Components/Clinics/AppointmentLogs/ClinicAppointmentListCard.vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    getAppointmentFilterData(loading_more) {
      this.fetching = true;
      axios
        .post(this.route("getApiClinicsFilterAppointmentLogs"), this.filter)
        .then((res) => {
