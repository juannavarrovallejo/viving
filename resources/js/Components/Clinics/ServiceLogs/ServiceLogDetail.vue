    ...
    <div class="section py-5">
      <div class="container">
            ...
            <div class="card-body">
              ...
              >
                ...
                <h4
                  class="badge"
                  :style="{
                    backgroundColor: getBadgeBackgroundColor(service.service_status_name),
                  }"
                >
              ...
              <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3"    v-if="service.patient_name">
                                        <div
                                            class="d-flex flex-column rounded-4 p-3 stats">
                  ...
                  <b class="fs-5">{{ __("comment") }}: </b> {{ userRating.comment }}
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <span class="fs-5 text-black">{{ service.question }}</span>
                                        </div>
                                    </div>
        ...
        <div class="row justify-content-end" v-if="showMarkedAsCompletedButton">
          ...
          <div v-if="service.service_status_code == 2" class="mt-5">
            <chat-component
              @showCompletedButton="() => (this.showMarkedAsCompletedButton = true)"
              :service="service"
            ></chat-component>
          </div>
  ...
  methods: {
    ...
    updateServiceStatus(status_code) {
      ...
      this.serviceStatusForm
        ...
        .post(this.route("clinic.service_detail.updateStatus"), {
          onSuccess: () => {
            if (status_code == 5) {
