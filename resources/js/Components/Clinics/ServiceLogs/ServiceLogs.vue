    ...
    <div class="stats py-5">
      <div class="container mt-md-5 p-md-0">
        ...
        <div class="container py-4" v-else>
          <clinic-service-list-card :services="services"></clinic-service-list-card>
          <div class="col-12">
...
import ClinicServiceListCard from "@/Components/Clinics/ServiceLogs/ClinicServiceListCard.vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    getServiceFilterData(loading_more) {
      this.fetching = true;
      axios.post(this.route("getApiClinicFilterServiceLogs"), this.filter).then((res) => {
