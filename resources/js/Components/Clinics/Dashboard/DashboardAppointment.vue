      ...
      <div class="card-body px-0">
        ...
        <div class="tab-content p-3" id="pills-tabContent">
          ...
          >
            ...
            >
              <!-- :href="route('clinic.appointment_log.detail', { type: 'clinic' })" -->
              ...
              <tbody>
                ...
                >
                  ...
                  <td style="color: #696868" class="border-bottom fs-4" v-else>-</td>
                  <td style="color: #696868" class="border-bottom fs-4">
                    {{ this.getDisplayAmount(ele.fee) }}
                  </td>
                  <td class="border-bottom">
                    <a
                      :href="route('clinic.appointment_log.detail', { id: ele.id })"
              ...
              <tbody>
                ...
                >
                  <th
                    style="color: #696868 !important"
                    scope="row"
                    class="bg-transparent fs-4 border-bottom"
                  >
                    {{ ele.patient_name }}
                  </th>
                  <td
