                ...
                <div class="card h-100 shadow">
                    <div class="d-flex align-items-center justify-content-between p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h3 class="fs-3 fw-bold text-muted mb-0">
                                {{ __("Last Week") }}
                            </h3>
                        </div>
                    ...
                    <div>
                      <h3 style="color: #268f3d" class="fs-4 fw-bold">$50</h3>
                        ...
                        <div class="d-flex justify-content-center">
                            <Button @click="walletPage" :href="route('wallet')" style="background-color: #f4f9fd"
                                class="rounded-pill fs-3 fw-bold text-paragraphcolor py-2 border border-primary w-100 m-3">
                                {{ __("show all") }}
                            </Button>
                        </div>
                    </div>
