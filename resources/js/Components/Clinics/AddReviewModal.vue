  ...
  <Modal maxWidth="md" :id="id">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="rating text-center fs-3 text-warning mb-3">
          <star-rating
        ...
        <div class="d-flex justify-content-center">
          <ul class="user-rating w-75">
            <li>
              ...
              <div class="rating">
                <star-rating
                  v-model:rating="form.experience"
                  :star-size="25"
                ></star-rating>
              </div>
            </li>
...
export default defineComponent({
  ...
  methods: {
    ...
    submit() {
      this.form.post(this.route("patients.add_clinic_review"), {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
