          ...
          <div class="col-md-12">
            ...
            <div class="col-12">
                ...
                <div class="col-12">
                  <div class="row p-4 bg-primary bg-opacity-10 rounded-5 mx-0">
                    ...
                    <label class="fs-5 fw-regular ms-1 mb-3" for="">{{
                      __(
                        "Toggle the button to designate holidays and working days"
                      )
                    }}</label>
                    <div
              ...
              <div
                ...
                class="col-12 bg-white p-4 time-list mt-4 rounded-4"
              >
                <div>
                  <div
                  ...
                  >
                    ...
                    >
                      <div
                        class="accordion-header py-2 bg-white rounded-4 shadow-none d-flex align-items-center justify-content-between w-100 px-3"
    ...
    <div v-else>
      <div class="row mt-4 mx-0 p-3 time-list rounded-4">
        <div class="d-flex align-items-center justify-content-between pb-3">
          <span class="fw-bold fs-3">{{ __("Your Generated Slots") }}</span>
            ...
            >
              ...
              >
                <li class="nav-item" role="presentation">
                  <button
                    class="nav-link fs-3 active d-flex text-black align-items-center gap-2"
