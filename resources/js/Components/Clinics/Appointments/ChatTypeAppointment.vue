<template>
  <div v-if="fetching">
    <div class="skeleton-structure time-slots">
            ...
            <div class="p-4 bg-primary bg-opacity-10 rounded-5 mx-0">
              ...
              <div class="col-12">
                <p v-if="isCommissionEnabled()">
                  ...
                  commission for legal services is
                  <span
                    v-if="
                      commission && commission.commission_type == 'fixed_rate'
                    "
                    >{{ getDefaultCurrencySymbol() }}
                  ...
                  <span
                    v-if="
                      commission && commission.commission_type == 'percentage'
                    "
                  >
                    {{ commission.rate }}%</span
                  >
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <button
                  ...
                  class="submit btn btn-primary rounded-4 shadow-find fw-bold px-4"
                >
