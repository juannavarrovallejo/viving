<template>
  ...
  <div>
    ...
    <div v-else>
      <div class="row mt-4 mx-0 bg-white cat-card p-3 time-list rounded-4">
        <div
          class="d-flex align-items-center justify-content-between pb-3 mb-4 border-bottom border-primary"
        >
        ...
        <div class="accordion border-0 p-0" id="accordionExample">
          ...
          >
            <div
              class="accordion-header rounded-4 shadow-none d-flex align-items-center justify-content-between w-100 pt-2 px-3"
