    ...
    <div class="stats p-6">
      <div class="container mt-md-5 p-md-0">
          ...
          <div class="col-md-5 right-side-bars p-md-0">
            ...
            >
              ...
              >
                <select
                  v-model="filter.search"
                  class="form-select shadow-none rounded-4"
                  aria-label="Select Filter"
                >
        ...
        <div class="container py-4" v-else>
          <doctor-appointment-list-card :appointments="appointments">
          </doctor-appointment-list-card>
...
import DoctorAppointmentListCard from "@/Components/Doctors/AppointmentLogs/DoctorAppointmentListCard.vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    getAppointmentFilterData(loading_more) {
      this.fetching = true;
      axios
        .post(this.route("getApiDoctorFilterAppointmentLogs"), this.filter)
        .then((res) => {
