        ...
        <Modal maxWidth="lg" :id="id">
            <div class="modal-content rounded-50">
                    ...
                    <table class="table" v-if="modalData">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td v-html="modalData.description"></td>
                            </tr>
                            <tr>
                                <th>
                                    {{ __("image") }}
                                ...
                                <td v-if="modalData.image">
                                    <img :src="modalData.image" width="75" height="75" :alt="modalData.slug" />
                                    &nbsp &nbsp
                                </td>
                                <td v-else>-</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td v-else>
                                    <iframe width="420" height="315" :src="convertToEmbed(modalData.file_url)"
                ...
                <div class="modal-footer p-4">
                    <button type="button" class="btn btn-secondary shadow-find" data-bs-dismiss="modal"
                        @click="close()">
                        {{ __("close") }}
                    </button>
                </div>
