    ...
    <Modal maxWidth="lg" :id="id">
      <div class="modal-content rounded-50">
        <div class="modal-header border-0">
          ...
          >
            {{ modalData ? __("update") : __("create") }} {{ __("podcast") }}
          </h5>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            >
              ...
              >
                <button
                  ...
                  :id="`podcasts-nav-${lang.code}-tab`"
                  data-bs-toggle="tab"
                  :data-bs-target="`#podcasts-nav-${lang.code}`"
                  type="button"
                  role="tab"
                  :aria-controls="`podcasts-nav-${lang.code}`"
                  aria-selected="true"
                >
                  {{ lang.name }}
                </button>
            ...
            >
              <div
                ...
                :id="`podcasts-nav-${lang.code}`"
                role="tabpanel"
                :aria-labelledby="`podcasts-nav-${lang.code}-tab`"
              >
                <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                >
                <select
                  v-model="form.podcast_category_id"
                  class="form-select"
                  aria-label="category"
                >
                  <option value="">{{ __("select") }}</option>
                  <option
                    v-for="cat in this.podcast_categories"
                    :key="cat.id"
                    :value="cat.id"
                  >
                    {{ cat.name }}
            ...
            <div class="col-md-6">
              ...
              >
                ...
                <input
                  id="doctor-audio"
                  @change="onPodcastFileChange($event, 'audio')"
                  type="file"
                />
              ...
              >
                ...
                <input
                  id="doctor-video"
                  @change="onPodcastFileChange($event, 'video')"
                  type="file"
                />
          ...
          <!-- <div class="form-group mb-3">
                      ...
                      <input id="doctor-image" ref="formImage" class="custom-file-input w-100"  @change="onFileChange" type="file" />
                  </div> -->
...
export default defineComponent({
  ...
  methods: {
    ...
    computed: {},
    create() {
      this.form.post(this.route("doctors.doctor_podcasts.store"), {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    update() {
      this.form
        ...
        .post(
          this.route("doctors.doctor_podcasts.update", {
            doctor_podcast: this.modalData.id,
          }),
          {
            preserveState: true,
            preserveScroll: true,
