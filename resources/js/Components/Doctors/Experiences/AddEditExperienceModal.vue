      ...
      <div class="modal-content rounded-50">
        <div class="modal-header py-4 px-5 border-0">
          <h5 class="modal-title text-primary fs-1 fw-bold" id="exampleModalLabel">
            {{ modalData ? __("update") : __("create") }} {{ __("experience") }}
          </h5>
          <button
            :id="id + 'close'"
            type="button"
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <VueDatePicker class="border border-2" v-model="form.from"></VueDatePicker>
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <VueDatePicker class="border border-2" v-model="form.to"></VueDatePicker>
...
export default defineComponent({
  ...
  methods: {
    ...
    computed: {},
    create() {
      this.form.post(this.route("doctors.doctor_experiences.store"), {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    update() {
      this.form
        ...
        .post(
          this.route("doctors.doctor_experiences.update", {
            doctor_experience: this.modalData.id,
          }),
          {
            preserveState: true,
            preserveScroll: true,
