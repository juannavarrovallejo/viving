<template>
  ...
  >
    ...
    <!-- <GenerateAppointmentVue></GenerateAppointmentVue> -->

    <!-- <div v-for="(appointmentType, appIndex) in appointment_types" :key="appIndex">
      <GenerateAppointmentVue
        :appointment_type_id="appointmentType.id"
        :is_schedule_required="appointmentType.is_schedule_required"
        :appointment_type="appointmentType.type"
      ></GenerateAppointmentVue>
...
import VideoTypeAppointment from "@/Components/Doctors/Appointments/VideoTypeAppointment.vue";
import AudioTypeAppointment from "@/Components/Doctors/Appointments/AudioTypeAppointment.vue";
import ChatTypeAppointment from "@/Components/Doctors/Appointments/ChatTypeAppointment.vue";
import GenerateAppointmentVue from "./GenerateAppointment.vue";
