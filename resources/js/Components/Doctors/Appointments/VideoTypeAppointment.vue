          ...
          >
            ...
            >
              ...
              >
                ...
                <li class="nav-item" role="presentation">
                  <button
                    class="nav-link d-flex fs-3 text-black align-items-center gap-2"
                    ...
                    <div v-if="addForm.generated_slots.length > 0">
                      <div class="row border shadow-sm mt-3 rounded-5 mx-3">
                        <div class="col-md-12 p-0">
                          <div
                            class="accordion-header rounded-4 shadow-none d-flex align-items-center justify-content-between w-100 py-3 px-3"
