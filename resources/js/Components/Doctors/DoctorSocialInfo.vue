        ...
        settings: [
          {
            ...
            value: this.$page.props.doctor.doctor_settings["facebook_url"] ?? "",
          },
          {
            name: "twitter_url",
            display_name: "Twitter/X",
            image_url: "twitter.png",
            value: this.$page.props.doctor.doctor_settings["twitter_url"] ?? "",
          },
          {
            name: "youtube_url",
            display_name: "Youtube",
            image_url: "youtube.png",
            value: this.$page.props.doctor.doctor_settings["youtube_url"] ?? "",
          },
          {
            name: "tiktok_url",
            display_name: "TikTok",
            image_url: "tiktok.png",
            value: this.$page.props.doctor.doctor_settings["tiktok_url"] ?? "",
          },
          {
            name: "linkedin_url",
            display_name: "Linkedin",
            image_url: "linkedin.png",
            value: this.$page.props.doctor.doctor_settings["linkedin_url"] ?? "",
          },
          {
            name: "whatsapp_url",
            display_name: "Whatsapp",
            image_url: "whatsapp.png",
            value: this.$page.props.doctor.doctor_settings["whatsapp_url"] ?? "",
          },
          {
            name: "snapchat_url",
            display_name: "Snapchat",
            image_url: "snapchat.png",
            value: this.$page.props.doctor.doctor_settings["snapchat_url"] ?? "",
          },
          {
            name: "instagram_url",
            display_name: "Instagram",
            image_url: "instagram.png",
            value: this.$page.props.doctor.doctor_settings["instagram_url"] ?? "",
          },
          {
            name: "pinterest_url",
            display_name: "Pinterest",
            image_url: "pinterest.png",
            value: this.$page.props.doctor.doctor_settings["pinterest_url"] ?? "",
          },
        ],
      }),
    };
