...
<!--                                :src="modalData.image" alt="logo">-->
                ...
                <div class="form-group mb-3">
                    ...
                    <input id="doctor-image" ref="formImage" class="w-100 custom-file-input"  @change="onFileChange" type="file" />
                </div>
                <div class="form-group mb-3">
...
export default defineComponent({
    ...
    methods:{
        ...
        create(){
            this.form.post(this.route('doctors.doctor_educations.store'), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
        ...
        update(){
            this.form.transform((data) => ({
                    ...data,
                     file: this.form.file,
                    _method: "PUT",
                })).post(this.route('doctors.doctor_educations.update',{doctor_education:this.modalData.id}), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
